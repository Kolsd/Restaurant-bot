...
Variables de entorno críticas:
  ...
  CLOUDINARY_CLOUD_NAME,        # Catálogo visual v2 — Fase 2. MVP usa free tier 25 GB.
  CLOUDINARY_API_KEY,           # Catálogo visual v2 — Fase 2. MVP usa free tier 25 GB.
  CLOUDINARY_API_SECRET,        # Catálogo visual v2 — Fase 2. MVP usa free tier 25 GB.
```
