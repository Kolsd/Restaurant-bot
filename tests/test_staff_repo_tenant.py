"""
tests/test_staff_repo_tenant.py

Unit tests verifying that staff_repo functions correctly enforce tenant
...
async def test_a_db_get_staff_calls_set_config_with_tenant_id():
    """
    db_get_staff inside tenant_scope(5) must trigger
